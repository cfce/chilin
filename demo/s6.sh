...
chilin simple -u qinq -s hg38 --threads 8 -i TRRAP_S6 -o S6 -t GSM566158/SRR060525.fastq,GSM759661/SRR309193.fastq -c GSM759671/SRR309203.fastq -p narrow -r tf --dont_remove
