...
if [ -S which wget &>/dev/null ]
then
wget -c --no-check-certificate https://raw.githubusercontent.com/pypa/virtualenv/1.9.X/virtualenv.py &>/dev/null
...
# echo "please install mdseqpos manually, see https://bitbucket.org/cistrome/cistrome-applications-harvard/src/270e986a26a0ab3b143dbf9720d990f3654f677f/mdseqpos/?at=default"
